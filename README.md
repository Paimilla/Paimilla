...
- Model evaluation
- OpenCV
- TensorFlow / PyTorch (aprendizaje continuo)
- Flutter
- Dart
- SharedPreferences
- FL Chart
...
- LinkedIn: https://www.linkedin.com/in/felipe-paimilla-4000a2206/
- GitHub: https://github.com/Paimilla

---

## English version

Hi, I am Felipe Paimilla.

Computer Civil Engineer focused on Machine Learning and Computer Vision, building applied solutions for detection, classification, and image analysis.

### What I do

- Build computer vision solutions for real-world use cases.
- Work on image detection and classification pipelines.
- Experience creating, cleaning, and curating datasets for model training.
- Bridge ML models with usable applications and clear user experience.
- Experience in automation, platform migration, and technical support.
- Background in cloud computing, software development, and agile project execution.
...
- Responsive redesign and DNS conflict resolution.
- Inventory automation with Google Apps Script for 90+ technology assets.
- Hardware modernization (HDD to SSD) and advanced technical support.
- Excel dashboard implementation for traffic fine management.
...
- Model evaluation
- OpenCV
- TensorFlow / PyTorch (continuous learning)
- Flutter and Dart for deployment-oriented interfaces
